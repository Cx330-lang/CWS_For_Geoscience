...
def main():
    ...
    tf_board_callback = keras.callbacks.TensorBoard(log_dir='./logs/bert_bigru_crf1', 
		histogram_freq = 1,
                                write_graph = True,
                                write_images = False,
		embeddings_freq = 1,
    ...
    eval_callback = EvalCallBack(kash_model=model, x_data=dev_x, y_data=dev_y, truncating=True,step=1)
